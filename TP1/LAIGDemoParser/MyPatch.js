function MyPatch(scene, id, degree1, degree2, controlvertexes, translation) {
	...
	this.makeSurface(id,this.deg1,this.deg2,this.ctrlvertexes,translation);
...
MyPatch.prototype.makeSurface = function (id, deg1, deg2, ctrlvertexes, translation) {
	...
	var nurbsSurface = new CGFnurbsSurface(deg1, deg2, knots1, knots2, ctrlvertexes); // TODO  (CGF 0.19.3): remove knots1 and knots2 from CGFnurbsSurface method call. Calculate inside method.
